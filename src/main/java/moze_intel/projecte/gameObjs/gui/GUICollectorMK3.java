...
public class GUICollectorMK3 extends GuiContainer
{
	...
	{
		this.fontRendererObj.drawString(Constants.formatEmc(tile.displayEmc), 91, 32, 4210752);
		
		double kleinCharge = tile.displayItemCharge;
		if (kleinCharge != -1)
			this.fontRendererObj.drawString(Constants.formatEmc(kleinCharge), 91, 44, 4210752);
	}
